...
class System extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('administrator/m_system', 'm');
	}
	...
	public function users_edit($user_id='0') {
	...
	public function groups_edit($group_id=0) {
		$data['sidebars'] = $this->m->sidebar_get();
	...
	public function sidebars_fetch() {
		$sidebars = $this->m->sidebar_get();
		print_r(json_encode($sidebars));
	}
...
public function navbars() {
	...
	public function navbars_fetch() {
		$navbars = $this->m->navbar_get();
		print_r(json_encode($navbars));
	}
	...
	function quick_search() {
		...
		$this->load->view('administrator/quicksearch/search', $data, FALSE);
	}

}

/* End of file System.php */
/* Location: ./application/controllers/administrator/System.php */
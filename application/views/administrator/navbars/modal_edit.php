...
<div class="row">
	<div class="col-md-6 form-group">
		...
		<input value="<?php echo $var->navbar_controller ?>" autocomplete="off" type="text" name="navbar_controller" class="form-control" required="">
	</div>
	<div class="col-md-6 form-group">
		<label>Function</label>
		<input value="<?php echo $var->navbar_function ?>" autocomplete="off" type="text" name="navbar_function" class="form-control" required="">
	</div>
</div>
<div class="row">
	<div class="col-md-6 form-group">

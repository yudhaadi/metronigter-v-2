...
<div class="row">
	<div class="col-md-6 form-group">
		...
		<input autocomplete="off" type="text" name="navbar_controller" class="form-control" required="">
	</div>
	<div class="col-md-6 form-group">
		<label>Function</label>
		<input autocomplete="off" type="text" name="navbar_function" class="form-control" required="">
	</div>
</div>
<div class="row">
	<div class="col-md-6 form-group">

...
<div class="row">
	<div class="col-md-6 form-group">
		...
		<input autocomplete="off" type="text" name="sidebar_controller" class="form-control" required="">
	</div>
	<div class="col-md-6 form-group">
		<label>Function</label>
		<input autocomplete="off" type="text" name="sidebar_function" class="form-control" required="">
	</div>
</div>
<div class="row">
	<div class="col-md-6 form-group">

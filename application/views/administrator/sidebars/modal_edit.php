...
<div class="row">
	<div class="col-md-6 form-group">
		<label>Parent</label>
		<select required="" class="form-control" name="sidebar_parent">
...
<div class="row">
	<div class="col-md-6 form-group">
		...
		<input value="<?php echo $var->sidebar_controller ?>" autocomplete="off" type="text" name="sidebar_controller" class="form-control" required="">
	</div>
	<div class="col-md-6 form-group">
		<label>Function</label>
		<input value="<?php echo $var->sidebar_function ?>" autocomplete="off" type="text" name="sidebar_function" class="form-control" required="">
	</div>
</div>
<div class="row">
	<div class="col-md-6 form-group">

<div class="kt-portlet kt-portlet--height-fluid">
	...
	<div class="kt-portlet__body">
		<form id="form" method="post" action="<?php echo base_url('administrator/system/users_save') ?>">
			<div class="row">
			...
			<div class="row mt-3">
				<div class="col-sm-6 col-md-6 col-lg-6">
					...
					<input value="<?php echo $users->user_birth ?>" required="" type="text" autocomplete="off" class="form-control" name="user_birth">
				</div>
				<div class="col-sm-6 col-md-6 col-lg-6">
			...
			<div class="row mt-3">
				<div class="col-sm-6 col-md-6 col-lg-6">
					<label>Grup</label>
					<select required="" autocomplete="off" class="form-control" name="user_group_id">
	...
	form.submit(function(event) {
		$.post(form.attr('action'), form.serialize(), function(response, textStatus, xhr) {
			if (response.status == true) {
				...
				setTimeout(function() {
					window.location.href = "<?php echo base_url('administrator/system/users') ?>";
				}, 2000);
			} else {
